"""
Node Generation Agent - Generates nodes based on conversation history.
This agent analyzes conversation history and generates appropriate nodes for the canvas.
"""
...
def create_node_generation_agent():
    ...
    - Generates appropriate node types (file, process, etc.)
                    ...
                    "nodes": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "type": {"type": "string", "description": "Node type (file, process, data, api, database)"},
